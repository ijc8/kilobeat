...
You can run a server with `./run.sh`; this requires some Python 3 dependencies, as listed in `requirements.txt`. A public test server is available at [kilobeat.fly.dev](https://kilobeat.fly.dev/).
